...
pub const MAX_PREFIX_BIT_WIDTH: usize = PREFIX_FR_LENGTH * 256;
...
pub const MAX_SUFFIX_BIT_WIDTH: usize = SUFFIX_FR_LENGTH * 256;
...
pub const CHUNK_BIT_WIDTH: usize = 8;
...
pub const PUBLIC_INPUTS_BYTES_WIDTH: usize = (PREFIX_FR_LENGTH + SUFFIX_FR_LENGTH + 2) * 32;
pub const PUBLIC_INPUTS_BIT_WIDTH: usize = PUBLIC_INPUTS_BYTES_WIDTH * 8;
pub const FR_CHUNKS_BIT_WIDTH: usize = CHUNK_WIDTH * 8;
